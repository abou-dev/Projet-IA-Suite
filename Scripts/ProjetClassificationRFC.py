...
evaluate_and_display_performance(default_model, X_test, y_test, "Modèle par défaut")
...
print("Meilleurs hyperparamètres pour Random Forest :", grid_search.best_params_)
optimized_time = time.time() - start_time

# Évaluation du modèle optimisé
optimized_model = grid_search.best_estimator_
evaluate_and_display_performance(optimized_model, X_test, y_test, "Modèle optimisé")
